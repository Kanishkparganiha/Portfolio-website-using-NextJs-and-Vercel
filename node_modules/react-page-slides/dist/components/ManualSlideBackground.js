...
var ManualSlideBackground = /** @class */ (function (_super) {
    ...
    ManualSlideBackground.prototype.getBackgroundStyles = function () {
        ...
        return __assign({ backgroundSize: 'cover' }, this.props.style, { margin: 0, padding: 0, backfaceVisibility: 'hidden', height: height + "px", width: '100%', transform: "translateX(0px) translateY(" + translateY + "px)", position: 'absolute', top: 0, left: 0, zIndex: -1 });
    };
